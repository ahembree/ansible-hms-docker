---
title: Version 1.9
description: "Release notes for HMS-Docker v1.9 — automatic app bootstrapping for Sonarr, Radarr, Prowlarr, Lidarr, and Readarr."
sidebar:
  order: -9
---

- Add automatic app bootstrapping for the apps (see [the docs](/docs/getting-started/app-bootstrap)):
  - Sonarr
  - Radarr
  - Prowlarr
  - Lidarr
...
Click [here to see the docs](/docs/getting-started/container-overrides) on how to implement this
