---
title: Version 1.10
description: "Release notes for HMS-Docker v1.10 — adds Backrest backups, Cleanuparr, health checks, and Arr-Scripts support."
sidebar:
  order: -10
---
...
See [the new docs](/docs/services/arr-scripts)
