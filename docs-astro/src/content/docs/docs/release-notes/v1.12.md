---
title: Version 1.12
description: "Release notes for HMS-Docker v1.12 — updates Watchtower image, Traefik tag control, Authentik 2025.10, and bootstrap fixes."
sidebar:
  order: -12
---
...
You will need to do manual steps BEFORE running the playbook, otherwise Authentik will fail to start. These steps are available in [these Authentik docs](/docs/services/authentik#upgrading-authentik)
...
Follow the steps in [these Authentik docs](/docs/services/authentik#upgrading-authentik)
