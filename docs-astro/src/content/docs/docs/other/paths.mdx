...
description: "Reference for the default directory structure used by HMS-Docker on the host and within containers for media and config files."
---
...
- /
  - mnt/
    - hms-docker/ # The 'mount_path' in these docs (default is /mnt/ + project_name), mounted to '/data' within containers
      - media_data/ # The 'primary mount name' in these docs
