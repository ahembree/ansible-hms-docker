...
- [Scrutiny](https://github.com/analogj/scrutiny): drive health monitoring <Badge text="New" variant="success"/>
- [Beszel](https://github.com/henrygd/beszel): observability <Badge text="New" variant="success"/>
