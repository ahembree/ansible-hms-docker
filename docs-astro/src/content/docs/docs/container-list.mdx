...
description: "Complete list of all available containers in HMS-Docker including media servers, download clients, and management tools."
---
...
- [Librariarr](https://github.com/ahembree/librariarr): media library management for Plex, Jellyfin, and Emby <Badge text="New" variant="success"/>
...
- [Seerr](https://github.com/seerr-team/seerr): A merger of both Overseerr and Jellyseerr
...
- [Byparr](https://github.com/ThePhaseless/Byparr): CAPTCHA solving (FlareSolverr alternative) <Badge text="New" variant="success"/>
...
- [Dockhand](https://github.com/Finsys/dockhand): container management GUI
...
- [n8n](https://n8n.io/): workflow automations
- [Scrutiny](https://github.com/analogj/scrutiny): drive health monitoring
- [Beszel](https://github.com/henrygd/beszel): observability
...
The repository includes a Claude Code skill that walks through all of the steps below and the conventions that go with them. See [Adding Containers with Claude Code](/docs/other/claude-skill).
