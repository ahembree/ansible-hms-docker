---
title: Authentik
description: "Set up Authentik SSO with forward auth proxy in HMS-Docker for per-container authentication, including Cloudflare Tunnel support."
---
...
In order to use Authentik, you must be using [SSL](/docs/services/traefik/ssl) as outlined in this project.
...
6. Configure an Application Outpost
    ...
    5. Expand `Advanced settings`
        ...
        **IMPORTANT**: copy the content of the file for the container generated in: `/opt/hms-docker/apps/authentik/outposts/authentik-<container_name>.outpost.yml` to your clipboard
