---
title: Common Issues
description: "Solutions for frequently encountered HMS-Docker problems including port conflicts, permission issues, and container startup failures."
---
...
1. **Verify DNS resolution:** `nslookup <container>.<domain>` — should resolve to your server's IP. If it doesn't resolve, check your DNS server configuration or create the required DNS record (see [DNS docs](/docs/getting-started/dns))
