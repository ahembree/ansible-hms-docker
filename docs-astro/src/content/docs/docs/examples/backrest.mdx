---
title: Backrest
description: "Guide to configuring Backrest for backing up your HMS-Docker installation to S3, OneDrive, Google Drive, and other destinations."
---

import { Badge, Steps } from '@astrojs/starlight/components';


Backrest is available to perform backups. Configuring Backrest repositories is outside the scope of this project due to the wide variety of backup destinations and configurations available.
...
5. List your available snapshots by using the "run command" from within your Backrest repository:
...
OneDrive is supported as a backup destination through rclone, since Backrest/restic does not have native OneDrive support.
